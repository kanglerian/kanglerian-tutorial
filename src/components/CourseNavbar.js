    ...
    <div className='text-gray-800 text-sm'>
      <nav className='container mx-auto px-4'>
        <div className='flex flex-wrap flex-col md:flex-row justify-start md:items-center md:justify-between md:gap-10 py-4'>
          <div className='flex flex-wrap items-center justify-between md:gap-10'>
          ...
          <div className={`${visible === true ? '' : 'hidden'} md:block w-full md:w-auto md:mt-0`}>
            <ul className='flex items-center justify-center mt-5 md:mt-0 flex-row md:space-x-2'>
              <NavLink exact className={pathname === "/" ? "font-bold" : ""} to='/'>
                <li className='hover:bg-gray-700 md:hover:bg-transparent hover:text-sky-300 px-4 py-1 rounded' role='button'>My Courses</li>
              </NavLink>
              <NavLink className={pathname === "/tutorials" ? "font-bold" : ""} to='/tutorials'>
                <li className='hover:bg-gray-700 md:hover:bg-transparent hover:text-sky-300 px-4 py-1 rounded' role='button'>Purchases</li>
              </NavLink>
              <NavLink className={pathname === "/account" ? "font-bold" : ""} to='/courses'>
                <li className='flex items-center gap-2 border border-gray-100 px-1 text-xs py-1 rounded-full' role='button'>
              ...
              <NavLink className={pathname === "/tutorials" ? "font-bold" : ""}>
                <li className='hover:bg-gray-700 md:hover:bg-transparent hover:text-sky-300 px-4 py-1 rounded' role='button'>
